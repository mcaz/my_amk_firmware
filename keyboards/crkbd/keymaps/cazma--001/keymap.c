...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // タブ        del        backspace  ↑          cursorPrev cursorNext          ctl+左     ctl+右     *******    |          \          `
  //|----------+----------+----------+----------+----------+----------.        |----------+----------+----------+----------+----------+----------|
  ...
  //|----------+----------+----------+----------+----------+----------.        |----------+----------+----------+----------+----------+----------|
     XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,            XXXXXXX,   KC_CAPS,   KC_PGUP,   XXXXXXX,   XXXXXXX,   XXXXXXX,
  // *******    *******    *******    *******    *******    *******             *******    CapsLock   pageUp,    *******    *******    *******
  //|----------+----------+----------+----------+----------+----------.        |----------+----------+----------+----------+----------+----------|
     XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,            XXXXXXX,   KC_HOME,   KC_PGDN,   KC_END,    XXXXXXX,   XXXXXXX,
  // *******    *******    *******    *******    *******    *******             *******    home       pageDown   end        *******    *******
  //|----------+----------+----------+----------+----------+----------.        |----------+----------+----------+----------+----------+----------|
